...
export const vi: { [Key in keyof typeof en]: string } = {
  nav: 'Mô hình',
  title: 'Mô hình',
  intro: 'Nhập API key của bạn để sử dụng mô hình từ các nhà cung cấp bên dưới.',
  edit: 'Chỉnh sửa',
  editProvider: 'Chỉnh sửa {provider}',
  remove: 'Xóa',
  removeProvider: 'Xóa {provider}',
  deleteTitle: 'Xóa {provider}?',
  deleteDescription: 'Xóa {provider} sẽ gỡ bỏ cấu hình của nó. Khóa xác thực (nếu có) được quản lý ở nơi khác và sẽ được giữ lại.',
  deleteDescriptionWithCredential: 'Xóa {provider} sẽ gỡ bỏ cấu hình và API key đã lưu trữ.',
  ...
  readOnly: 'Tệp cấu hình đang ở chế độ chỉ đọc trong môi trường này.',
  loadFailed: 'Tải danh mục nhà cung cấp thất bại',
  conflict: 'Cài đặt đã bị thay đổi ở nơi khác trong khi mở bảng này. Vui lòng đóng và mở lại để chỉnh sửa trên giá trị hiện tại.',
  retry: 'Thử lại',
  keyInput: 'API key',
  keyPlaceholder: 'Nhập API key của bạn',
  keyPlaceholderNative: 'Nhập API key hoặc để trống để sử dụng xác thực môi trường',
  ...
  baseUrl: 'Địa chỉ Base URL',
  baseUrlDefault: 'Mặc định của nhà cung cấp',
  models: 'Danh mục mô hình',
  modelsInherited: 'Đang dùng mặc định của bộ điều hợp',
  modelsCustomized: 'Đã tùy chỉnh danh mục mô hình',
  resetModels: 'Khôi phục mặc định',
  model: 'Mô hình',
  modelId: 'Mã Model ID',
  modelName: 'Tên hiển thị',
  modelNamePlaceholder: 'Mặc định dùng Model ID khi để trống',
  contextWindow: 'Cửa sổ ngữ cảnh',
  contextWindowPlaceholder: 'Sử dụng mặc định của nhà cung cấp',
  maxTokens: 'Token đầu ra tối đa',
  maxTokensPlaceholder: 'Sử dụng mặc định của nhà cung cấp',
  modelAdvanced: 'Dung lượng',
  addModel: 'Thêm mô hình',
  removeModel: 'Xóa mô hình',
  modelsEmpty: 'Không có mô hình nào được hiển thị trong menu chọn. Các ID ngoài danh mục vẫn có thể gửi trực tiếp.',
  keyBlank: 'Nhập API key hoặc để trống để giữ khóa hiện tại.',
  keyBlankNew: 'Nhập API key hoặc để trống nếu nhà cung cấp này xác thực theo cách khác.',
  keyIllegalCharacters: 'Định dạng API key không hợp lệ. Vui lòng kiểm tra lại.',
  modelIdRequired: 'Bắt buộc phải có Model ID.',
  modelIdDuplicate: 'Model ID không được trùng lặp.',
  ...
  advancedHint: 'Các trường khác nằm trong settings.yaml; vui lòng chỉnh sửa trực tiếp phần đó.',
  modelCapacityInvalid: 'Dung lượng phải là một số, có thể thêm hậu tố K hoặc M.',
  modelDuplicate: 'Mỗi Model ID chỉ xuất hiện một lần.',
  modelContextWindow: 'Cửa sổ ngữ cảnh',
  modelMaxTokens: 'Token đầu ra tối đa',
  fetchModels: 'Lấy danh sách mô hình',
  fetching: 'Đang truy vấn nhà cung cấp…',
  fetchNeedsBaseUrl: 'Vui lòng nhập Base URL trước khi lấy danh sách.',
  fetchEmpty: 'Nhà cung cấp không trả về mô hình nào. Vui lòng thêm thủ công.',
  fetchTitle: 'Chọn mô hình cần thêm',
  fetchDescription: 'Dưới đây là các mô hình khả dụng từ nhà cung cấp. Chọn mô hình bạn muốn thêm.',
  fetchAdopt: 'Thêm mục đã chọn',
  customAdd: 'Thêm nhà cung cấp tùy chỉnh',
  customTitle: 'Nhà cung cấp tùy chỉnh',
  customTag: 'Tùy chỉnh',
  customRoute: 'Provider ID',
  customRouteHint: 'Định danh chữ thường bắt đầu bằng chữ cái, dùng định danh duy nhất cho nhà cung cấp.',
  customRouteInvalid: 'Bắt đầu bằng chữ thường; tiếp theo là chữ thường, chữ số và dấu gạch nối.',
  customRouteTaken: 'Đã có nhà cung cấp sử dụng ID này.',
  ...
  welcomeError: 'Không thể lưu xác nhận lúc này. Vui lòng thử lại.',
