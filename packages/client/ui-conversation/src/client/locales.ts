...
const PLAN_NEXT_ACTION_VI = 'mô tả nhiệm vụ của bạn để lập kế hoạch'
...
export const vi = {
  ...
  'hint.goal': 'Nhập mục tiêu cho tác vụ dài hạn',
  'hint.goal.active': 'Mục tiêu đang chạy — edit để sửa / pause để tạm dừng / resume để tiếp tục / clear để xóa',
  'placeholder.plan': PLAN_NEXT_ACTION_VI,
  'placeholder.default': 'Nhập tin nhắn cho trợ lý AI',
  'placeholder.unavailable': 'Đoạn chat không khả dụng',
  'placeholder.parentOffline': 'Đoạn chat cha đã ngoại tuyến; không thể gửi thêm nhưng vẫn có thể dừng tác vụ',
  ...
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter để điều hướng tất cả tin nhắn đang chờ',
  'input.accessMode': 'Chế độ truy cập, hiện tại: {name}',
  'image.dropTitle': 'Kéo thả ảnh vào đây để đính kèm',
  'image.dropDesc': 'Tối đa {count} ảnh, mỗi ảnh {size}',
  'image.dropBlocked': 'Hiện tại không thể thêm ảnh',
  ...
  'image.closePreview': 'Đóng xem trước ảnh',
  'image.serviceUnavailable': 'Dịch vụ đọc ảnh không khả dụng',
  'image.unsupportedType': 'Chỉ hỗ trợ định dạng PNG, JPG, WebP và GIF',
  'image.tooMany': 'Mỗi tin nhắn chỉ có thể kèm tối đa {count} ảnh',
  'image.fileTooLarge': 'Dung lượng mỗi ảnh phải nhỏ hơn {size}',
  'image.totalTooLarge': 'Tổng dung lượng ảnh vượt quá {size}; vui lòng xóa bớt ảnh',
  'image.tooManyPixels': 'Độ phân giải ảnh quá lớn; vui lòng nén ảnh và thử lại',
  'image.modelUnsupported': 'Mô hình hiện tại không hỗ trợ hình ảnh; vui lòng đổi mô hình hỗ trợ thị giác',
  'image.subagentUnsupported': 'Đoạn chat subagent hiện chưa hỗ trợ hình ảnh',
  'image.sendFailed': 'Gửi ảnh thất bại ({reason}); vui lòng thêm lại và thử lại',
  'context.aria': 'Đã sử dụng {percent} ngữ cảnh',
  ...
  'stats.ttftAverage': 'TTFT TB {duration}',
  'stats.tokensPerSecond': '{throughput} tok/s',
  ...
  'settings.enter.description': 'Chỉ áp dụng khi agent đang chạy; Cmd/Ctrl+Enter thực hiện hành vi còn lại',
  'settings.enter.queue': 'Xếp hàng',
  'settings.enter.steer': 'Điều hướng (Steer)',
  'access.confirm.title': 'Bật quyền Full access?',
  'access.confirm.description': 'Full access giảm thiểu các bước xác nhận và cho phép agent thực hiện trực tiếp nhiều thao tác hơn, bao gồm thao tác nhạy cảm, thay đổi file hoặc lệnh ngoài. Chỉ nên dùng khi bạn tin tưởng tác vụ hiện tại.',
  'access.confirm.acknowledge': 'Tôi hiểu rõ rủi ro và muốn tiếp tục',
  'access.confirm.cancel': 'Hủy',
  'access.confirm.enable': 'Bật Full access',
  'hero.headline': 'Khám phá thế giới mới',
  'hero.preview': 'Bản xem trước',
  'hero.chooseWorkspace': 'Chọn không gian làm việc',
  'session.hierarchy': 'Cấu trúc phân cấp đoạn chat',
  'details.title': 'Chi tiết',
  'details.close': 'Đóng chi tiết',
  'details.empty': 'Bấm vào một hàng công cụ trong luồng tin nhắn để xem chi tiết',
  'details.notInWindow': 'Lượt gọi này nằm ngoài cửa sổ hiện tại',
  ...
  'todo.rowTitle': 'Cập nhật danh sách nhiệm vụ',
  'todo.completed': '{done}/{total} hoàn thành',
  'chat.deepDiving': 'Đang suy nghĩ sâu…',
  'row.think': 'Suy nghĩ',
  'chat.loadingHistory': 'Đang tải lịch sử…',
  'chat.loadError': 'Tải lịch sử thất bại: {message} ({code})',
  'chat.loadOlder': 'Tải tin nhắn cũ hơn',
  'chat.toBottom': 'Cuộn xuống dưới cùng',
  'message.extraBlock': 'Khối nội dung bổ sung',
  'message.contextInjection': 'Tiêm ngữ cảnh',
  'message.contextRecall': 'Truy hồi đoạn chat',
  'message.context.instructions.loaded': 'đã nạp',
  'message.context.instructions.added': 'đã thêm',
  'message.context.instructions.updated': 'đã cập nhật',
  'message.context.instructions.removed': 'đã gỡ bỏ',
  'message.context.catalog.replaced': 'Danh mục thay thế',
  'message.context.catalog.more': '… thêm {count} mục nữa',
  'message.context.snapshot.supersedes': 'Thay thế các bản snapshot trước',
  'message.context.relay.from': 'Từ đoạn chat {session}',
  'message.context.recall.counts': 'Giữ lại {retained} mục · Bỏ qua {omitted} mục',
  'message.context.recall.truncated': 'đã rút gọn',
  ...
  'message.branch': 'Rẽ nhánh sang đoạn chat mới',
  'message.branchUnavailable': 'Chỉ khả dụng trên tin nhắn cuối cùng của một lượt đã hoàn tất',
  'message.retry.active': 'Đang thử lại yêu cầu mô hình',
  'message.retry.cancelled': 'Đã hủy thử lại yêu cầu mô hình',
  'message.retry.started': 'Đã bắt đầu thử lại yêu cầu mô hình',
  ...
  'message.turnError': 'Lượt chạy này thất bại',
  'message.maxTokens': 'Đã đạt giới hạn token đầu ra',
  'message.maxTokens.hint': 'Câu trả lời bị cắt ngắn; phần nội dung trước đó vẫn được lưu trong đoạn chat. Gửi "tiếp tục" để mô hình tiếp tục phản hồi.',
  'message.ranFor': 'Thực thi trong {duration}',
  'message.ttft': 'TTFT {seconds}s',
  'message.tokensPerSecond': '{tps} tok/s',
  'duration.seconds': '{seconds}s',
  ...
  'command.title': 'Lệnh',
  'approval.waiting': 'Chờ phê duyệt',
  'approval.detail.aria': 'Chi tiết phê duyệt',
  'approval.escalation': 'Công cụ {toolName} yêu cầu quyền thực thi đặc quyền',
  ...
  'queue.edit': 'Chỉnh sửa tin nhắn chờ',
  'queue.edit.unsupported': 'Chứa nội dung phi văn bản; hiện chưa hỗ trợ chỉnh sửa',
  'queue.save': 'Lưu tin nhắn chờ',
  'queue.cancelEdit': 'Hủy chỉnh sửa',
  'queue.remove': 'Xóa tin nhắn chờ',
  'queue.steer': 'Điều hướng tin nhắn chờ',
