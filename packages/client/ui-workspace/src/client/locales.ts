...
export const vi = {
  ...
  'sessions.expand': 'Mở rộng thêm {n} đoạn chat',
  'sessions.collapse': 'Thu gọn',
  'empty.none': 'Chưa có đoạn chat nào',
  'empty.noMatches': 'Không tìm thấy kết quả',
  'workspace.add': 'Thêm không gian làm việc',
  'search.sessions.aria': 'Tìm kiếm đoạn chat',
  'search.placeholder': 'Tìm kiếm đoạn chat…',
  'search.clear': 'Xóa tìm kiếm',
  'search.results.aria': 'Kết quả tìm kiếm',
  'search.pending': 'Đang tìm kiếm lịch sử chat…',
  'search.unavailable': 'Tìm kiếm nội dung tạm thời không khả dụng, chỉ hiển thị theo tên.',
  'search.noMatches': 'Không tìm thấy đoạn chat phù hợp',
  'search.hasMore': 'Chỉ hiển thị {n} kết quả đầu tiên. Vui lòng thu hẹp phạm vi tìm kiếm.',
  ...
  'rename.session.title': 'Đổi tên đoạn chat',
  'field.workspaceName': 'Tên không gian làm việc',
  'field.sessionName': 'Tên đoạn chat',
  'delete.workspace': 'Xóa không gian làm việc',
  'delete.desc': 'Thao tác này sẽ gỡ “{name}” khỏi danh sách. Thư mục và lịch sử chat vẫn được lưu giữ và hiển thị ở mục Chưa phân nhóm.',
  'delete.pending': 'Đang xóa không gian làm việc…',
  'menu.fork': 'Rẽ nhánh đoạn chat',
  'menu.archiveSession': 'Lưu trữ đoạn chat',
  'sessions.count.one': '{n} đoạn chat',
  'sessions.count.other': '{n} đoạn chat',
  'actions.workspace.aria': 'Thao tác không gian làm việc “{name}”',
  'actions.session.aria': 'Thao tác đoạn chat “{name}”',
  'actions.newSession.aria': 'Tạo đoạn chat mới trong “{name}”',
  ...
  'status.planReview': 'Chờ duyệt kế hoạch',
  'status.waitingAnswer': 'Chờ phản hồi',
