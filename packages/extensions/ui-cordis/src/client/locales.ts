...
export const vi = {
  ...
  'row.removeTitle': 'Gỡ bỏ Plugin Cordis',
  'purpose.missing': '(chưa có mục đích)',
  ...
  'status.removed': 'Đã gỡ bỏ',
  'status.superseded': 'Đã có lượt chạy mới hơn',
  'run.removed': 'Gói này không còn tồn tại',
  'run.superseded': 'Đã có thẻ chạy mới hơn bên dưới',
  'panel.hint': 'Các điều khiển chạy nằm trong bảng Cordis phía trên Cài đặt',
  ...
  'panel.readFailed': 'Đọc danh mục plugin thất bại: {message}',
  'panel.group.current': 'Đoạn chat này',
  'panel.group.others': 'Các đoạn chat khác',
  ...
  'action.approvePlugin': 'Cho phép các phiên bản tương lai của plugin này',
  ...
  'render.failedAbdicated': 'Hiển thị thất bại trong {slot}; đã khôi phục giao diện mặc định:',
  'render.failedHeld': 'Hiển thị thất bại trong {slot}:',
